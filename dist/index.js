var QuillColorPickerEnhance = (function (exports) {
  'use strict';
  ...
  const COLORS$1 = ['#000000', '#e60000', '#ff9900', '#ffff00', '#008a00', '#0066cc', '#9933ff', '#ffffff', '#facccc', '#ffebcc', '#ffffcc', '#cce8cc', '#cce0f5', '#ebd6ff', '#bbbbbb', '#f06666', '#ffc266', '#ffff66', '#66b966', '#66a3e0', '#c285ff', '#888888', '#a10000', '#b26b00', '#b2b200', '#006100', '#0047b2', '#6b24b2', '#444444', '#5c0000', '#663d00', '#666600', '#003700', '#002966', '#3d1466'];
    ...
    buildPickers(selects, icons) {
      this.pickers = Array.from(selects).map(select => {
        ...
        if (select.classList.contains('ql-background') || select.classList.contains('ql-color')) {
          ...
          if (select.querySelector('option') == null) {
            fillSelect$1(select, COLORS$1, format === 'background' ? '#ffffff' : '#000000');
          }
          return new ColorPicker$1(select, icons[format]);
        }
        if (select.querySelector('option') == null) {
  ...
  function fillSelect$1(select, values) {
